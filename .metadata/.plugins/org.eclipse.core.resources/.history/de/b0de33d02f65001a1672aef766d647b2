...
public class BlackjackClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("ディーラーの一枚目のカードは" + toDescription(dealer.get(0)));

		System.out.println("あなたの二枚目のカードは" + toDescription(player.get(1)));
		...
		if(playerPoint == dealerPoint) {
			...
			System.out.println("ゲームには負けたけど心では勝ってる。あんたが大将！");
		}
	...
	//トランプの数字を得点計算用のポイントに変換するメソッド.J/Q/Kは１０とする
